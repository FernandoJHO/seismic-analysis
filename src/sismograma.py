...
opcion = input("Mostrar sismograma (amplitud) = 1 |||| Mostrar ruido (aprox.) = 2 |||| Mostrar sismograma (frecuencias) = 3 |||| Mostrar gráfico STA/LTA = 4: \n")
...
if(opcion=='1'):
    ...
    if (opcion=='2'):
        ...
        if(opcion=='3'):
            espectro_frecuencia = espectroFrecuencia(datos_sismo)
